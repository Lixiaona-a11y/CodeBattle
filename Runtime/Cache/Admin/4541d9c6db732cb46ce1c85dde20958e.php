<?php if (!defined('THINK_PATH')) exit(); switch($addons_config["editor_type"]): case "1": ?>
	...
	<?php case "2": ?>
		<input type="hidden" name="parse" value="0">
		<?php if(($addons_config["editor_wysiwyg"]) == "1"): ?><link rel="stylesheet" href="/codebattle/Public/static/kindeditor/default/default.css" />
			<script charset="utf-8" src="/codebattle/Public/static/kindeditor/kindeditor-min.js"></script>
			<script charset="utf-8" src="/codebattle/Public/static/kindeditor/zh_CN.js"></script>
			<script type="text/javascript">
		...
		<?php else: ?>
			<script type="text/javascript" charset="utf-8" src="/codebattle/Public/static/ueditor/ueditor.config.js"></script>
			<script type="text/javascript" charset="utf-8" src="/codebattle/Public/static/ueditor/ueditor.all.js"></script>
			<script type="text/javascript" charset="utf-8" src="/codebattle/Public/static/ueditor/lang/zh-cn/zh-cn.js"></script>
			<script type="text/javascript">
				$('textarea[name="<?php echo ($addons_data["name"]); ?>"]').attr('id', 'editor_id_<?php echo ($addons_data["name"]); ?>');
				window.UEDITOR_HOME_URL = "/codebattle/Public/static/ueditor";
	...
	<?php case "3": ?>
		<script type="text/javascript" src="/codebattle/Public/static/jquery-migrate-1.2.1.min.js"></script>
		<script charset="utf-8" src="/codebattle/Public/static/xheditor/xheditor-1.2.1.min.js"></script>
		<script charset="utf-8" src="/codebattle/Public/static/xheditor/xheditor_lang/zh-cn.js"></script>
		<script type="text/javascript" src="/codebattle/Public/static/xheditor/xheditor_plugins/ubb.js"></script>
		<script type="text/javascript">
	...
	<?php case "4": ?>
		<link rel="stylesheet" href="/codebattle/Public/static/thinkeditor/skin/default/style.css">
		<script type="text/javascript" src="/codebattle/Public/static/jquery-migrate-1.2.1.min.js"></script>
		<script type="text/javascript" src="/codebattle/Public/static/thinkeditor/jquery.thinkeditor.js"></script>
		<script type="text/javascript">
			$(function(){
				$('textarea[name="<?php echo ($addons_data["name"]); ?>"]').attr('id', 'editor_id_<?php echo ($addons_data["name"]); ?>');
				var options = {
